      ...
      <Bounded className='flex justify-center'>
        <main className='w-full max-w-[62.625rem]'>
          <div className='text-center mb-16 md:mb-20 lg:mb-28'>
            ...
            <p className='text-balance text-xl/base md:text-2xl font-display text-slate-600 w-[28.5rem] mx-auto'>Descubra seu fluxo ideal: organize tarefas, hábitos e energia no seu ritmo.</p>
